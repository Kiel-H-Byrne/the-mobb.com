...
const ClientHome = React.memo(({ initialListings, initialCategories }: ClientHomeProps) => {
  const [mapInstance, setMapInstance] = useState<any>(null);
  const [listings, setListings] = useState<Listing[] | null>(initialListings);
  const [categories, setCategories] = useState<Category[] | null>(initialCategories);
  ...
  const [selectedCategories, setSelectedCategories] = useState<Set<Category>>(new Set(initialCategories));
